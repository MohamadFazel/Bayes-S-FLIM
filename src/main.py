...
# ly = sio.loadmat(
#     "/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/SpectralFlim/data_flim/1color_LysoRed_Lifetime_3point3ns_shiftedIRF_Offset_2point5_Sigma_point54_Bg_23percent.mat"
# )
# vi = sio.loadmat(
#     "/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/SpectralFlim/data_flim/1color_viaFluor_Lifetime_4point9ns_shiftedIRF_Offset_2point5_Sigma_point6_Bg_10percent.mat"
# )
...
# # print(dt_l.shape, dt_m.shape, dt_v.shape)
...
# lambda_ = np.load("/home/reza/software/Spectral-FLIM/phasor/data/spec.npy")
# lambda_ = np.expand_dims(lambda_, axis=0)
# print(lambda_.shape)
# exit()
#################################################################
...
lambda_ = np.load("/home/reza/software/Spectral-FLIM/phasor/data/spec.npy")
lambda_ = np.expand_dims(lambda_, axis=0)
dt = np.load("/home/reza/software/Spectral-FLIM/phasor/data/dt6.npy")
