...
def sample_bg(
    ...
    a_prop = np.sum(
        sc.gamma.logpdf(pi_bg_old, alpha_prop, scale=(pi_bg_prop / alpha_prop))
    ) - np.sum(sc.gamma.logpdf(pi_bg_prop, alpha_prop, scale=(pi_bg_old / alpha_prop)))
