...
def generate_map_1():
    ...
    indices = [
        ...
        (3, 7, 8), (4, 15, 16), (24, 2, 3),
        (5, 8, 9), (6, 15, 17), (23, 3, 5),
        (7, 9, 10), (8, 16, 18), (22, 5, 6),
        (9, 10, 11), (10, 18, 19), (21, 6, 7),
        (11, 10, 11), (12, 19, 20), (20, 7, 8),
        (13, 10, 12), (14, 20, 21), (19, 9, 11),
        (15, 11, 12), (16, 21, 22), (19, 11, 13),
        (17, 11, 12), (18, 22, 23), (18, 13, 14),
        (19, 12, 13), (20, 23, 24), (17, 15, 16),
        (21, 13, 14), (22, 24, 25), (16, 17, 18),
        (23, 13, 14), (24, 25, 27), (16, 19, 21),
        (25, 14, 15), (26, 28, 29), (18, 21, 22),
        (27, 15, 16), (28, 29, 30), (17, 23, 24),
        (29, 15, 16), (29, 29, 30), (16, 25, 26),
        (15, 26, 28), (14, 27, 28),
        (13, 28, 29), (12, 29, 30),
        (10, 30, 31),
    ]
...
def generate_map_2():
    ...
    tmp_im = (
        (np.random.randint(28000,32000)) * norm.pdf(X_grid, loc=8, scale=3) * norm.pdf(Y_grid, loc=8, scale=4.5)
    )
    tmp_im[tmp_im > 170] = 0
    tmp_im[tmp_im < 60] = 0
    ...
    tmp_im = (
        (np.random.randint(7000,9000)) * norm.pdf(X_grid, loc=13, scale=3.2) * norm.pdf(Y_grid, loc=24, scale=3.1)
    )
    tmp_im[tmp_im > 120] = 0
    tmp_im[tmp_im < 80] = 0
...
def generate_map_5():
    ...
    star_coords = [
        (16, 5), (18, 12), (25, 12), (20, 16), (22, 24),
        (16, 20), (10, 24), (12, 16), (7, 12), (14, 12)
    ]
