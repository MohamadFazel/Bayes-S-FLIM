...
drc = "pics"
eta_mi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Eta_green_0209104931.npy")
eta_vi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Eta_1color_viaFluor_Lifetime_4point9ns_shiftedIRF_Offset_2point5_Sigma_point6_Bg_10percent_0204155656.npy")
eta_ly = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Eta_1color_LysoRed_Lifetime_3point3ns_shiftedIRF_Offset_2point5_Sigma_point54_Bg_23percent_0205161217.npy")

pi_mi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Pi_green_0209104931.npy")
pi_vi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Pi_1color_viaFluor_Lifetime_4point9ns_shiftedIRF_Offset_2point5_Sigma_point6_Bg_10percent_0204155656.npy")
pi_ly = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Pi_1color_LysoRed_Lifetime_3point3ns_shiftedIRF_Offset_2point5_Sigma_point54_Bg_23percent_0205161217.npy")

eta = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Eta_mixl31_0326090758.npy")
pi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/Pi_mixl31_0326090758.npy")
phi = np.load("/media/reza/44ec9f87-1051-4bdf-8f53-fcf9d10c68a5/FLIM_results/int_mixl31_0326090758.npy")
...
plt.axvline(1/np.mean(eta_mi[:,1]), linestyle='--', color='g', label='LysoRed ground truth', alpha=0.5)

plt.hist(1/eta[-20000:,1], bins=100, color='r', alpha=1, label='ViaFlour learned', density=True)
plt.hist(1/eta[-20000:,0], bins=100, color='g', alpha=1, label='LysoRed learned', density=True)
plt.hist(1/eta[-20000:,2], bins=100, color='b', alpha=1, label='MitoOrange learned', density=True)
...
plt.hist(1/eta[-20000:,2], bins=100, color='b', alpha=1, label='species 1', density=True)
plt.hist(1/eta[-10000:,8], bins=100, color='k', alpha=1, label='Species 2', density=True)
plt.hist(1/eta[-20000:,3], bins=100, color='g', alpha=1, label='species 3', density=True)
plt.hist(1/eta[-20000:,1], bins=100, color='r', alpha=1, label='species 4', density=True)
plt.hist(1/eta[-20000:,0], bins=100, color='c', alpha=1, label='species 5', density=True)
plt.hist(1/eta[-10000:,7], bins=100, color='orange', alpha=1, label='Species 6', density=True)
plt.hist(1/eta[-10000:,6], bins=100, color='purple', alpha=1, label='Species 7', density=True)
plt.hist(1/eta[-10000:,5], bins=100, color='y', alpha=1, label='Species 8', density=True)
plt.hist(1/eta[-10000:,4], bins=100, color='#00FF00', alpha=1, label='Species 9',density=True)
